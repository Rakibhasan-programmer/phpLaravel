        ...
        <div class="row clearfix">
            ...
            <div class="image-column col-lg-6">
                <div class="image">
                    ...
                    <img src="{{asset('/')}}front/assets/img/a.jpg" alt="">
                </div>
            </div>
            <!--Content Column-->
                ...
                <div class="testimonial-sliders">
                    <div class="single-testimonial-slider">
                        <div class="client-avater">
                            <img src="{{asset('/')}}front/assets/img/avaters/avatar1.png" alt="">
                        </div>
                    ...
                    <div class="single-testimonial-slider">
                        <div class="client-avater">
                            <img src="{{asset('/')}}front/assets/img/avaters/avatar2.png" alt="">
                        </div>
                        <div class="client-meta">
                    ...
                    <div class="single-testimonial-slider">
                        <div class="client-avater">
                            <img src="{{asset('/')}}front/assets/img/avaters/avatar3.png" alt="">
                        </div>
                        <div class="client-meta">
            ...
            <div class="col-lg-12">
                <div class="logo-carousel-inner">
                    <div class="single-logo-item">
                        <img src="{{asset('/')}}front/assets/img/company-logos/1.png" alt="">
                    </div>
                    <div class="single-logo-item">
                        <img src="{{asset('/')}}front/assets/img/company-logos/2.png" alt="">
                    </div>
                    <div class="single-logo-item">
                        <img src="{{asset('/')}}front/assets/img/company-logos/3.png" alt="">
                    </div>
                    <div class="single-logo-item">
                        <img src="{{asset('/')}}front/assets/img/company-logos/4.png" alt="">
                    </div>
                    <div class="single-logo-item">
                        <img src="{{asset('/')}}front/assets/img/company-logos/5.png" alt="">
                    </div>
                </div>
            </div>
        </div>
