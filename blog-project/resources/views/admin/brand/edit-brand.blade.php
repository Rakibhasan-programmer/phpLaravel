                ...
                <div class="card-body">
                    ...
                    <form action="{{route('update-brand', ['id' => $brand->id])}}" method="POST">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-8">
                                <label><input class="me-1" type="radio" name="status" value="1" {{ $brand->status == 1 ? 'checked' : "" }}>Published</label>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-8">
                                <input type="submit" class="btn btn-outline-success" value="Update Brand">
                            </div>
                        </div>
                    </form>
                </div>
