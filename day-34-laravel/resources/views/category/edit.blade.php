        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <div class="card">
                        <div class="card-header text-center fw-bold fs-3">Add Category Form</div>
                        <div class="card-body">
                            ...
                            <form action="{{route('category.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row pb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="submit" class="btn btn-outline-dark px-5 fw-bold" value="Create New Category">
                                    </div>
                                </div>
                            </form>
                        </div>
